...
function App() {
  const stripePromise = loadStripe("pk_test_51P2najSFP2JwroaNrLFHEpNb1tIVdpsYQdMEUOWOeroB9AxoIEJYt9XgV5CASWtlCpoQM1UtAUxC59N4RbanyOX200EW6n3w4c");
  ...
  const router = createBrowserRouter(
    ...
    createRoutesFromElements(
      ...
      < Route path="/" element={<Main />} id="main" exact>
        ...
        />
        <Route id="payment" path="payment/:propertyId"
          element={
